...
if (!file_exists($data_file)) {
    echo "<b>Error !!</b> Can't find data file <br>";
	exit;
} else {
...
<?
      ...
      if ($jmlrec == 0) echo "<tr><td colspan=\"3\" bgcolor=\"#FFE1E1\" align=\"center\"><font size=\"3\"> <script> prt(\"noentriesyet\") </script> </font></td></tr>";
...
?>
   ...
   <font color="<?=$title_color?>" size="1"><a href="http://www.promosi-web.com/script/guestbook/" title="Ardguest 1.7" target="_blank"><font color="<?=$title_color?>">PHP Guestbook Info</font></a></font>
   <!-- Thank you -->
